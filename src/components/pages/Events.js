...
function Events(username , contact) {
...
onPress={()=>navigate("viewEventsCode",{ eventName : item.eventName , ticketType: item.ticketType ,earlyBPrice : item.earlyBPrice ,ordiPrice : item.ordiPrice  ,vipPrice : item.vipPrice , vvipPrice : item.vvipPrice })} 
    >
...
}} style={{ height : 100 , borderRadius: 10, width:45, alignSelf:'center'}} />}
          <Image source={defaultImage} style={{ height: 280, borderRadius: 10 , }} />
<View>
  <Text>Scotts Maphuma</Text>
  <Text>Jan 10 2025 12 00</Text>
  <Text>ZKS Arena Bulawayo</Text>
  <TouchableOpacity>
    ...
    >
      {/* { <Image source={{uri: "https://firebasestorage.googleapis.com/v0/b/truckers-cace6.appspot.com/o/Trucks%2F1741522836736?alt=media&token=5ed6d0b6-0c85-4264-8237-d91fb385633f"
        ...
        <View style={{backgroundColor:'red'}}>
          <Image source={defaultImage} style={{  height : 110 , borderRadius: 10, width:60, alignSelf:'center' }} />

        </View>
<View style={{marginLeft:10}}>
  <Text style={{fontWeight:'bold', fontSize:20 }}>Scotts Maphuma</Text>
  <Text style={{fontSize:15}}>Jan 10 2025 12 00</Text>
  <Text style={{fontWeight:'bold'}}>ZKS Arena Bulawayo</Text>
  <TouchableOpacity style={{height:30 , width:90 , backgroundColor:'red', justifyContent:'center' ,alignItems:'center', borderRadius:6}}  
  onPress={() => navigate("/viewEvent")}  >
