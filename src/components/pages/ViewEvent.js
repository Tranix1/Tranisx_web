...
function ViewEventsCode({username ,contact , }) {
        ...
        <Text style={{fontSize: 20 , color : 'white'}} > SELECKTA BURNOUT  </Text>
         ...
         <View>
          {/* <Text style={{marginBottom:60 , textAlign:'center',color:'green'}} >VIP TICKET</Text> */}
             ...
             {/* {!alreadyHveTicket && <View style={{justifyContent:'center',alignItems:'center'}} > */}
                {/* <Text style={{textAlign:'center', color :'blue'}} >Ecocash</Text> */}
                {/* <View style={{flexDirection:'row',justifyContent:'space-evenly',margin:7}} >
                    <TouchableOpacity onPress={()=>SetTicketPrice(2)}  style={{height:30 , borderWidth:1 , borderColor:'#6a0c0c', borderRadius:5 , width: 50,alignItems:'center',justifyContent:'center'}} >
                      <Text>Early</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={()=>SetTicketPrice(4)} >
                        
                      <Text>Ordin</Text>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={()=>SetTicketPrice(6)}>
                        
                      <Text>VIP</Text>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={()=>SetTicketPrice(8)}>
                  ...
                  <TextInput
                     ...
                     onChangeText={(text) => SetEcocashPhoneNum(text)}
                     style={inputstyles.inputElem}            
                  />

                  <TouchableOpacity onPress={handleSubmission} style={{width:100 , height : 25 , borderRadius:5 , backgroundColor:'green',alignSelf:'center',margin:5}} >
                    <Text style={{color:'white'}}>Submit</Text>
                  </TouchableOpacity>
                  
                </View> } 

              {alreadyHveTicket && <View style={{ display: "flex", justifyContent: "center", alignItems: "center", color:'green'}}>
...
<View>
  ...
  <Text>asdha sdashdashdsahkjashdjk asdjksahjkdashjkd sajkdhsajkd hkjashdjksa djkashd asdjksahd jashd sajhdjas hdjkashd jashdkjash djksahdjk sahdjksah djashd asdhsaj dksajdhjksahdsjkahdsjka djsakhd</Text>
</View>
