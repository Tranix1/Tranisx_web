...
function FirsHomePage({setDspFrstPage , checkAuth , navigation , username , blackLWarning , blockVerifiedU}){
  ...
  const [addStoreLoc, setStoreLoc] = React.useState("")

  function slctStoreCountry(sellOBuy){
    setStoreLoc(sellOBuy)
  }
...
/> */}
  ...
  The Future of Transport & Logistics
                ...
                {addStoreLoc&& <View style={{position:'absolute',top:20 , left:0 , right:0 , bottom: 0,zIndex:220,backgroundColor:'white'}} >
                   <TouchableOpacity onPress={() => navigate(`/DspShop/Zimbabwe/vehicles/${addStoreLoc}`)}  style={styles.buttonStyle} >
        ...
        <TouchableOpacity onPress={()=> navigation.navigate('slctAddShop', {location: "Malawi" }) }style={styles.buttonStyle} >
            <Text style={{color:'#FFC080'}}>Malawi </Text>
                ...
                <View style={{flexDirection:'row', justifyContent: 'space-around',marginBottom:10}} >
                  ...
                  <TouchableOpacity style={{height: 27 , width: 130 , borderRadius:60, backgroundColor:'#228B22',justifyContent:'center',marginTop:2 }}  onPress={() => navigate('/shoplocation')} >
...
{<TouchableOpacity    onPress={() => navigate('/loadsContracts')}     style={{  marginBottom : 8,  padding :7 ,borderWidth : 2 , borderColor:'#6a0c0c', borderRadius:8 ,  shadowColor: '#6a0c0c',
...
<View style={{margin:7}} >
  ...
  <View style={{flexDirection:'row'}} > 
        ...
        shadowOpacity: 0.7,
        shadowRadius: 5,   overflow: 'hidden',width:283}}
         onPress={() => navigate('/applyVerification')} >

                  <VerifiedIcon name="verified" style={{ color: 'rgba(34, 139, 34, 0.2)', alignSelf: 'center', fontSize: 125 }} />
                ...
                <View style={{margin:7}} >
                  ...
                  <Text style={{color:'#1E90FF',fontWeight:'bold'}}>Find Fast</Text>
                    ...
                    <TouchableOpacity onPress={() => navigate('/searchElement')}  style={{  borderWidth:1 , borderColor:'red' , zIndex :200 , borderRadius: 8,marginBottom:7,marginTop:7}} >
                      <View style={{flexDirection:'row',alignItems :"center" , justifyContent :"space-around", }} >
                      <Text style={{color : 'red',fontSize:12,fontWeight:'bold'}} >Search</Text>
                    {/* <FontAwesome name="search" size={18} color="red" /> */}
                        <SearchIcon style={{ color: 'red' , fontSize:18 }} />
                      </View>
                    <Text style={{color : 'red',fontSize:12,fontWeight:'bold',alignSelf:'center'}}>Logistics</Text>
                    </TouchableOpacity>

                   <TouchableOpacity onPress={()=> navigate('/shosearchElement') }  style={{ width : 70 , height : 35 ,  zIndex :200 , borderRadius: 8, borderWidth:1 , borderColor:'green'}} >
                <View  style={{flexDirection:'row',alignItems :"center" , justifyContent :"space-around", }}>

                <Text style={{color : 'green',fontSize:12,fontWeight:'bold'}} >Search</Text>
                        <SearchIcon style={{ color: 'green' , fontSize:18}} />
                </View>
                ...
                <View style={{flexDirection:'row'}} >
                  ...
                  { <TouchableOpacity style={{marginTop:7,borderWidth:2 , borderColor:'#0074D9',padding:5,  shadowColor: 'rgba(0, 116, 217, 0.2)',shadowOffset: { width: 1, height: 2 },shadowOpacity: 0.7,shadowRadius: 5,   overflow: 'hidden',borderRadius:8,width:283}} onPress={()=> navigate('/applyGit') } >
<ShieldIcon style={{color:'rgba(0, 116, 217, 0.2)',alignSelf:'center',fontSize:135}}  />
              ...
              <TouchableOpacity onPress={()=> navigate('/loads') }   style={{  borderWidth:1 , borderColor:'red' , zIndex :200 , borderRadius: 8,marginBottom:7,marginTop:7,flexDirection:'row',alignItems:'center'}} >
  ...
  <TouchableOpacity onPress={()=> navigate('/trucks') }   style={{  borderWidth:1 , borderColor:'red' , zIndex :200 , borderRadius: 8,marginBottom:7,marginTop:7,flexDirection:'row'}} >
        ...
        <View style={{flexDirection:'row'}} >
             { <TouchableOpacity style={{marginTop:7,borderWidth:2 , borderColor:'rgba(220, 20, 60)',padding:5,  shadowColor: 'rgba(0, 116, 217, 0.2)',shadowOffset: { width: 1, height: 2 },shadowOpacity: 0.7,shadowRadius: 5,   overflow: 'hidden',borderRadius:8 ,width:283}} onPress={()=> navigate('/events') } >
...
<View  style={{margin:7}} >
  ...
  <TouchableOpacity onPress={()=> slctStoreCountry("toBuy") }  style={{ width : 70 , height : 35 ,  zIndex :200 , borderRadius: 8, borderWidth:1 , borderColor:'green', marginBottom:10}} >
               ...
               <TouchableOpacity onPress={()=> slctStoreCountry("forSell") }   style={{ width : 70 , height : 35 ,  zIndex :200 , borderRadius: 8, borderWidth:1 , borderColor:'green'}} >
