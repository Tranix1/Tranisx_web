...
return(
    <View> 
        ...
        <View style={{flexDirection : 'row', paddingTop : 10 , justifyContent : 'space-evenly'}}>
          ...
          <TouchableOpacity onPress={()=> navigate("/createUser/")} style={{position :'fixed',top: 440 ,right:10 ,  alignItems :"center" , justifyContent :'center', backgroundColor:'#6a0c0c' , zIndex :200 , borderRadius: 8 , height : 15}} >
