...
import ApplyGit from "./components/verifyBlckList/ApplyGit"

// When one is applying for Verfication first time
import ApplyVerification from "./components/verifyBlckList/ApplyVerification"
    ...
    <View>
      ...
      {!isBlackListed ? <View >
        ...
        {smallMenu && <SmallMenu toggleSmallMenu={toggleSmallMenu} />}
            ...
            {dspFrstPage && <FirstHomePage setDspFrstPage={setDspFrstPage} checkAuth={checkAuth}  blockVerifiedU={blockVerifiedU} blackLWarning={blackLWarning} username = {username} />  }    
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/loadsContracts" element={<LoadsContracts username={username}
          contact={contact} blockVerifiedU={blockVerifiedU} blackLWarning={blackLWarning} />} />
   <Route path="/BookLContract" element={<LoadsContracts username={username}
          contact={contact} blockVerifiedU={blockVerifiedU} blackLWarning={blackLWarning} />} />
...
<Route path="/applyGit" element={<ApplyGit username={username}
          contact={contact} blockVerifiedU={blockVerifiedU} blackLWarning={blackLWarning} userIsVerified={isVerified} />} />
<Route path="/applyVerification" element={<ApplyVerification />} />
<Route path="/events" element={<Events username={username}
          contact={contact} blockVerifiedU={blockVerifiedU} blackLWarning={blackLWarning} userIsVerified={isVerified} />} />
<Route path="/viewEvent" element={<ViewEvent username={username}
          contact={contact} blockVerifiedU={blockVerifiedU} blackLWarning={blackLWarning} userIsVerified={isVerified} />} />
